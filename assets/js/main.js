...
window.showToast = function (message, type = 'info', duration = 5000) {
  ...
  switch (type) {
    ...
    default: // info
      ...
      iconSvg =
        '<svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9 5h2v2H9V5Zm0 4h2v7H9V9Z"/></svg>';
  }
